...
namespace TaskFlow.Web.Models
{
    public class RegistrationModel
    {
        ...
        [Required, StringLength(100, ErrorMessage = "The password must be at least {2} characters long.", MinimumLength = 6), DataType(DataType.Password), Display(Name = "Password")]
